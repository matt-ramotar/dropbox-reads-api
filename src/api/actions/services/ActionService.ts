...
interface ActionService {
  ...
  addActionReaction(actionId: string, actionReactionId: string): Promise<void>;
}
...
export default class RealActionService implements ActionService {
  ...
  public async addActionReaction(actionId: string, actionReactionId: string): Promise<void> {
    return await addActionReaction(actionId, actionReactionId);
  }
}
